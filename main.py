        ...
        <main class="row">
            <div class="row text-center">
                ...
                <div class="col-4">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="card-header py-3">
                            <h4 class="my-0 fw-normal">Оставьте свои данные и мы вам напишем! :)</h4>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form>
                                <div class="mb-3">
                                    <input type="email" placeholder="Имя" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>

                                <div class="mb-3">
                                    <input type="password" placeholder="Email" class="form-control" id="exampleInputPassword1">
                                </div>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            <p class="d-inline-flex gap-1">
                                ...
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#multiCollapseExample4" aria-expanded="false" aria-controls="multiCollapseExample4">Какая гарантия?</button>
                                <button class="btn btn-primary" type="button" data-bs-toggle="collapse" data-bs-target=".multi-collapse" aria-expanded="false" aria-controls="multiCollapseExample1 multiCollapseExample2">Закрыть</button>
                            </p>
